...
const updateCourse = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let course = yield Course_1.default.findById(req.params.id);
        if (!course) {
            return res.status(404).json({ message: 'Course not found' });
        }
        ...
        // Update course
        course = yield Course_1.default.findByIdAndUpdate(req.params.id, { $set: req.body }, { new: true, runValidators: true });
        res.json(course);
    }
    catch (error) {
...
const deleteCourse = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield Progress_1.default.deleteMany({ course: req.params.id });
...
const enrollCourse = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (req.user) {
            ...
            yield Progress_1.default.create({
                user: req.user._id,
                course: course._id,
                completedLessons: [],
