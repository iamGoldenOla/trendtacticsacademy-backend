-- Corrected alignment script based on your actual table structure
-- Run these queries in your Supabase SQL editor

-- First, let's check if the courses table exists (referenced by modules.course_id)
SELECT column_name, data_type, is_nullable 
FROM information_schema.columns 
WHERE table_name = 'courses' 
ORDER BY ordinal_position;

-- Let's also check the enrollments table (referenced by certificates.enrollment_id)
SELECT column_name, data_type, is_nullable 
FROM information_schema.columns 
