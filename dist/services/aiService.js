...
class AIService {
    ...
    async startSession(context) {
        ...
        try {
            ...
            console.error('TrendyAI Start Session Error:', ((_a = error.response) === null || _a === void 0 ? void 0 : _a.data) || error.message);
    ...
    async sendMessage(sessionId, message, context) {
        ...
        try {
            ...
            console.error('TrendyAI Chat Error:', ((_a = error.response) === null || _a === void 0 ? void 0 : _a.data) || error.message);
            // Fallback to local AI simulation if TrendyAI is unavailable
            if (process.env.NODE_ENV === 'development') {
    ...
    async getRecommendations(context) {
        ...
        try {
            ...
            console.error('TrendyAI Recommendations Error:', ((_a = error.response) === null || _a === void 0 ? void 0 : _a.data) || error.message);
    ...
    async getAnalytics(context) {
        ...
        try {
            ...
            console.error('TrendyAI Analytics Error:', ((_a = error.response) === null || _a === void 0 ? void 0 : _a.data) || error.message);
    ...
    async generateContent(context) {
        ...
        try {
            ...
            console.error('TrendyAI Content Generation Error:', ((_a = error.response) === null || _a === void 0 ? void 0 : _a.data) || error.message);
    ...
    async analyzeProgress(context) {
        ...
        try {
            ...
            console.error('TrendyAI Progress Analysis Error:', ((_a = error.response) === null || _a === void 0 ? void 0 : _a.data) || error.message);
    ...
    async personalizeLearningPath(context) {
        ...
        try {
            ...
            console.error('TrendyAI Personalization Error:', ((_a = error.response) === null || _a === void 0 ? void 0 : _a.data) || error.message);
    ...
    getDefaultWelcomeMessage(context) {
    ...
    async simulateAISession(context) {
        const sessionId = (0, uuid_1.v4)();
        return {
            sessionId,
    ...
    simulateRecommendations(context) {
        return [
            {
                id: '1',
                type: 'course',
    ...
    simulateContentGeneration(context) {
        return {
            type: context.type,
            content: {
                questions: [
    ...
    simulateProgressAnalysis(context) {
        return {
            insights: [
    ...
    simulatePersonalization(context) {
        return {
            path: [
                {
                    lessonId: 'lesson-1',
